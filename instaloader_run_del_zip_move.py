...
# move mp4 and jpg file to new folder create
# import os
# import shutil

# cwd = os.getcwd()

# sourcepath = cwd + '\\' + instagram_username
# destinationpathjpg = cwd + '\\' + instagram_username + '_jpg'
# destinationpathmp4 = cwd + '\\' + instagram_username + '_mp4'
